  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', pb: 8 }}>
      <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', gap: 2 }}>
        ...
        <Box>
          <Typography variant="h4" sx={{ fontWeight: 900, color: '#fff' }}>Your Account</Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary', fontWeight: 600 }}>Manage your sessions, historical CAS uploads, and ledger reconciliation.</Typography>
        </Box>
      </Box>
            ...
            {!comparingWith ? (
              <Box sx={{ textAlign: 'center', mt: 15 }}>
                ...
                <Typography variant="body1" sx={{ color: 'rgba(255,255,255,0.3)', mt: 1, maxWidth: 300, mx: 'auto' }}>
                  FolioPulse will perform a cryptographic ledger reconciliation against your current portfolio.
                </Typography>
              </Box>
            ) : compareLoading ? (
              <Box sx={{ textAlign: 'center', mt: 15 }}>
